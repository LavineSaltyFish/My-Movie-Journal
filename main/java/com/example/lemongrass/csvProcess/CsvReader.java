package com.example.lemongrass.csvProcess;
...
public final class CsvReader implements Iterable<CsvRow>, Closeable {
    ...
    public static final class CsvReaderBuilder {
        ...
        public CsvReader build(InputStream inputStream, final Charset charset) throws IOException {
            return newReader(new InputStreamReader(inputStream, charset));
        }
